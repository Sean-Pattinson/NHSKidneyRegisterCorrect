 ...
 * @author Nick Dalton
 */
public class BeforeVersionOfKidneyPatientRegister extends VirtualKidneyPatientRegister
{
    ...
    public BeforeVersionOfKidneyPatientRegister()
    { 
        reset(); 
    }
    //--------------------------------------------------------------------------
    void reset()
     { 
       // System.out.printf("RESET %s \n", "BeforeVersionOfKidneyPatientRegister "); 
   ...
   //---------------------------------------------------------------------------
    /**
     *  This is a missing comment in the documentation. 
     * @param Patient 
     * @param KidneyDonor 
     */
    @Override
